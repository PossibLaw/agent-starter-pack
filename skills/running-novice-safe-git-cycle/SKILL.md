...
4. Refresh canonical newest-first state in `.agent/PLAN.md` and `.agent/HANDOFF.md` (current baton + timeline), review the handoff for sensitive data, and include the handoff update in the commit.
