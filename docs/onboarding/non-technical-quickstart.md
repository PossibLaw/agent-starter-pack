...
- The installer keeps `.agent/HANDOFF.md` trackable for team continuity. Other `.agent/*.md` working-state files remain local by default.

If this repo already had the starter pack and you want to keep existing progress and handoff files, run:
